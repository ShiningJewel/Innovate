      ...
      <Container>
        ...
        <rect width="50" height="50" fill="white"/>
                        ...
                        <div className='justify-center ml-[26px]'>
                          <h3  className='w-[258px] font-secondary font-bold text-[22px] text-titleColor group-hover:text-white transition-all duration-500 leading[34px] mt-[26px]'>Plan Product Roadmap</h3>
                          <p className='w-[258px] font-primary text-paraColor group-hover:text-white transition-all duration-500 font-regular text-[16px] leading-[26px] mt-[8px] mb-[26px]'>A product roadmap is a shared source of truth that outlines the vision, direction, priorities</p>
                          <h6 className='flex w-[258px] items-center font-primary text-secondary group-hover:text-white transition-all duration-500 font-medium text-[16px] leading-[26px] mb-[26px]'>Read More <span className='ml-[4px]'><FaLongArrowAltRight /></span> </h6>
                        </div>
                      </div>
                    </div>
                    <div>
